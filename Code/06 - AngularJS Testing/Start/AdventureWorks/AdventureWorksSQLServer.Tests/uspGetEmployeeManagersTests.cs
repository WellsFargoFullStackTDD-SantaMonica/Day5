...
{
    [TestClass()]
    public class uspGetEmployeeManagersTests : SqlDatabaseTestClass
    {

        public uspGetEmployeeManagersTests()
        {
            InitializeComponent();
        }
        ...
        {
            SqlDatabaseTestActions testActions = this.NullCheckData;
        ...
        private SqlDatabaseTestActions NullCheckData;
    }
}
